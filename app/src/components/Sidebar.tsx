...
import { AudioLines, AudioWaveform, Box, Captions, type LucideIcon, Mic, Settings, Speaker, Volume2, Wand2 } from 'lucide-react';
...
const tabs: Array<{
  ...
  { id: 'story-flow', path: '/story-flow', icon: AudioWaveform, labelKey: 'nav.storyFlow' },
